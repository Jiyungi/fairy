...
describe("Feature: fairy, Property 16: Live result is parsed from the human transcript regardless of order or wording", () => {
  it("Feature: fairy, Property 16: Live result is parsed from the human transcript regardless of order or wording", () => {
