...
// runClinicCall — async; live path is unavailable for the hackathon so they
...
describe("Feature: fairy, Property 15: Call output conforms to its schema", () => {
  it("Feature: fairy, Property 15: Call output conforms to its schema", async () => {
    await fc.assert(
