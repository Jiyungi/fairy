...
describe("Feature: fairy, Property 18: Identity details withheld until verification requested", () => {
  it("Feature: fairy, Property 18: Identity details withheld until verification requested", () => {
  ...
  it("Feature: fairy, Property 18: pure engine withholds identity before any verify_request", () => {
