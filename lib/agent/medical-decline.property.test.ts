// ===========================================================================
// Property test — Feature: fairy, Property 19: Medical-decision requests are
...
const SAFE_OPENING =
  "Hi, I'm Fairy, an authorized assistant calling to ask a few questions.";
...
describe("Feature: fairy, Property 19: Medical-decision requests are declined", () => {
  it("Feature: fairy, Property 19: Medical-decision requests are declined", () => {
    fc.assert(
