// ===========================================================================
// Property test — Feature: fairy, Property 23: Appointment stays pending until
//   approval or timeout.
//
...
describe("Feature: fairy, Property 23: Appointment stays pending until approval or timeout", () => {
    ...
    await fc.assert(
      fc.asyncProperty(
        ...
        async (outcome) => {
          ...
          const { run, context } = await runFairyWorkflow(COUPLE_ID, h.deps);
