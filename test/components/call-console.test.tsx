...
import { CallConsole } from "@/components/fairy/CallConsole";
import {
  INSURANCE_RESULT_FIELDS,
  CLINIC_RESULT_FIELDS,
} from "@/components/fairy/call/fields";
import type {
  CallResultLike,
  CallType,
  Turn,
} from "@/components/fairy/call/types";
...
const SAMPLE_TRANSCRIPT: Turn[] = [
  { speaker: "agent", text: "Hi, I'm Fairy, verifying fertility benefits." },
...
describe("Feature: fairy, Property 28 (UI portion): LIVE iff not fallback, FALLBACK iff fallback (Task 22.2)", () => {
