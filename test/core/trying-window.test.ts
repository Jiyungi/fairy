...
describe("computeTryingWindow", () => {
  it("Feature: fairy, Property 1: trying-window algebraic relationships hold for any valid input", () => {
  ...
  it('Feature: fairy, Property 2: confidence is exactly "Low" with the exact reasons when unconfirmed and range > 7', () => {
  ...
  it("Feature: fairy, Property 3: output is identical regardless of any male data (male data is not even a parameter)", () => {
  ...
  it("Feature: fairy, Property 4: throws TryingWindowInputError for missing/invalid required fields", () => {
  ...
  it("Feature: fairy, seed-couple worked example produces the exact reference dates and Low confidence", () => {
