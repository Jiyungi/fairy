...
describe("detectMissingData", () => {
  it("Feature: fairy, Property 5: missing labs are flagged with grounded explanations", () => {
  ...
  it("Feature: fairy, Property 6: semen parameters flagged borderline iff below WHO 2021 limit", () => {
  ...
  it("Feature: fairy, Property 7: insurance flagged unverified iff coverage_status is not confirmed", () => {
  ...
  it("Feature: fairy, Property 8: checklist completeness — exactly the produced flags, each once, none spurious", () => {
