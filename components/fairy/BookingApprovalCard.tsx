...
import { Card, CardHeader, Field, FieldGroup } from "@/components/fairy/Card";
import { Chip } from "@/components/fairy/MissingFlag";
import {
      ...
      <div className="mt-5">
        {approved ? (
          <>
            ...
            >
              Thanks — Fairy is finalizing your June&nbsp;25 consult now. You
