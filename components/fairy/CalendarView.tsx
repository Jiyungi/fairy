 ...
 */
export function CalendarView({ cycle, events = [], tasks = [] }: CalendarViewProps) {
  ...
  const timeline = [...reminders, ...sourced].sort(
    ...
    <div className="space-y-4">
      ...
      <Card flush>
        <div className="px-5 pb-1 pt-5">
          <CardHeader title="On your calendar" description="Reminders and your booked consult" />
        </div>
        {timeline.length > 0 ? (
                ...
                <li key={item.id}>
                  ...
                  {isSelected && item.description ? (
                    <div
                      ...
                      className="fairy-rise mx-3 mb-2 rounded-lg bg-secondary/50 px-3.5 py-3"
                    >
