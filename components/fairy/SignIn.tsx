            ...
            {CHOICES.map((choice) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "fairy-rise group flex items-center gap-4 rounded-2xl border border-border/70 bg-card p-4 text-left shadow-card transition-colors duration-150 ease-out",
